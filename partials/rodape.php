            ...
            <div class="row g-md-4 gy-sm-5 gy-2">
                ...
                <div class="col-xxl-2 col-xl-4 col-sm-6">
                    ...
                    <ul class="footer-list footer-contact mb-sm-0 mb-3">
                        <li>
                            <a href="sobre.php" class="footer-contain-2">
                                <i class="fas fa-angle-right"></i>Sobre nós</a>
                        </li>
                        <li>
                            <a href="contato.php" class="footer-contain-2">
                                <i class="fas fa-angle-right"></i>Contate-nos</a>
                        </li>
                        <li>
                            <a href="term_condition.html" class="footer-contain-2">
                                <i class="fas fa-angle-right"></i>Termos e Condiçõess</a>
                        </li>
                        <li>
                            <a href="careers.html" class="footer-contain-2">
                                <i class="fas fa-angle-right"></i>Trabalhe conosco</a>
                        </li>
                        <li>
                            <a href="blog.php" class="footer-contain-2">
                        ...
                        <li class="list-1">
                            <div class="deal-offer-contain">
                                <a href="shop-left-sidebar.html" class="deal-image">
                                    <img src="assets/images/produtos/produto-fake.png" class="blur-up lazyload" alt="">
                                </a>
...
<div class="item-section">
    ...
    <ul class="items-image">
        <li>
            <img src="assets/images/produtos/produto-fake.png" alt="">
        </li>
        <li>
            <img src="assets/images/produtos/produto-fake.png" alt="">
        </li>
